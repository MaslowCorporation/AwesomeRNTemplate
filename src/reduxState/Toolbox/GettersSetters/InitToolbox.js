...
// Le AsyncThunk de récupération/triage de toutes les données stockées dans Toolbox.
 ...
 *
 * @returns la liste de tous les Toolbox (rows {key: value}).
 *
 ...
 */
export const InitToolbox = ({ onSuccess, onError, debugMode }) => {
