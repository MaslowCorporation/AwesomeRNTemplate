 ...
 * TestPageState stocké dans Redux.
...
export function GetFreshestTestPageStateFromGroup({ groupName }) {
  return useSelector((state) => state.TestPageState.groups[groupName]) ?? [];
}
