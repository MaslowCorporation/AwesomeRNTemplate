...
// Le AsyncThunk de récupération/triage de toutes les données stockées dans AppState.
 ...
 *
 * @returns la liste de tous les AppState (rows {key: value}).
 *
 ...
 */
export const InitAppState = ({ onSuccess, onError, debugMode }) => {
