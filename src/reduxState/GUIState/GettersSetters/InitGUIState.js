...
// Le AsyncThunk de récupération/triage de toutes les données stockées dans GUIState.
 ...
 *
 * @returns la liste de tous les GUIState (rows {key: value}).
 *
 ...
 */
export const InitGUIState = ({ onSuccess, onError, debugMode }) => {
