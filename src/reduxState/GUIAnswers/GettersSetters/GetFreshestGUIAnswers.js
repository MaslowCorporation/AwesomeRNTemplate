...
/**
 *
 * permet dobtenir les plus récents GUIAnswers stockés dans Redux/Sqlite
 *
 ...
 *
 */
export const GetFreshestGUIAnswers = () => {
  return useSelector((state) => state.GUIAnswers.allRows);
};
