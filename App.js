...
import { Home, hideSplashScreenWhenLoaded } from './AppPieces/AppInit';

// The component that displays the whole app
import { AppMainComponent } from './AppPieces/AppMainComponent';

// The mechanism that allows the king to speak to the kingdom
